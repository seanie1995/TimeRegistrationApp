...
const RegTime = () => {
    ...
    const { chosenDate, token, yesterdaysDateUS, todaysDateUS, setYesterdayPosts, setCurrentDayPosts, currentDayPosts,
        yesterdayPosts, timeSort } = useContext(AuthContext);
    ...
    }, [recordId, chosenDate, currentDayPosts, yesterdayPosts])
    ...
    const handlePatch = async () => {
        ...
        const API_URL = `http://localhost/modifyTime/${recordId}`;
        let URL = "";
        ...
        try {
            ...
            filteredData2 = {
                "fieldData": {
                    ...
                    "recordId": recordId,
                    "projectName": postToModify.fieldData.projectName
                }
            }
                    ...
                    >
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <Text style={styles.inputResult}>{postToModify.fieldData.projectName ? postToModify.fieldData.projectName : "Projektnamn"}</Text>
                            </View>
                            <View style={styles.inputContainer}>
                                <View style={styles.inputChild}>
                                    ...
                                    <TextInput
                                        style={styles.input}
                                        placeholder='Ange Artikelkod'
                                        value={recordId ? postToModify?.fieldData?.common_article_no || "" : formData.fieldData.common_article_no}
                                        onChangeText={(text) => handleChange('common_article_no', text)} />
                                </View>
                                <Text style={styles.inputResult}>Placeholder Text</Text>
                            </View>
                            <View style={styles.inputContainer}>
                                <View style={styles.inputChild}>
